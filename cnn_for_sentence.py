...
if __name__ == '__main__':
  ...
  #one-hot vector
  y_ = tf.one_hot(labels, depth=49, dtype=tf.float32)
  ...
  W_fc1 = weight_variable([4 * 4 * 64, 1024]) # image size has been reduced to 4x4, fully connected 1024 neurons
  ...
  print("test accuracy {0}".format(accuracy.eval(feed_dict={
      x: test_data, labels: test_label, keep_prob: 1.0})))
